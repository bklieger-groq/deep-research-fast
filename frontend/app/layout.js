                        ...
                        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
                            ...
                            <nav>
                                <ul className="flex gap-4">
                                    <li>
                                        <a href="https://github.com/bklieger-groq/deep-research-fast" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-primary-600 transition-colors flex items-center gap-1">
